...
//replace your image
Mat ImageToDraw = imread("/Users/albertlee/Desktop/jay.jpg");
Mat image;
...
int main() {
    ...
    while (true) {
        ...
        m_markerrecognizer.drawToImage(image, Scalar(0,0,255), 3);
...
void DrawImage(int i)
{
    ...
    Mat TransformMartix = getPerspectiveTransform(ImageCorners, m_markerrecognizer.getMarkers()[i].m_corners);
